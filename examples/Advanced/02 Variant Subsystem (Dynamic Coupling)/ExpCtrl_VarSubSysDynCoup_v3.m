function ExpCtrl_VarSubSysDynCoup_v3()
%% This is a PROTOYPE extension of the example "2 Variant Subsystem".
...
% "01 Variant Subsystem (simple)" and
% you can find further information about it ((link from 2021-Aug-18):
% http://de.mathworks.com/help/simulink/examples/variant-subsystems.html
%
% This function demonstrates the basic idea of an Reactive
...
for k = 1:size(vars,2)  %loop over all variants		 
    ...
    if ismember(vars(1,k),blocked)  %is VSS_MODE blocked 
        ...
        %get results
        is_times    = simresults.yout.time;        
        is_amp      = simresults.yout.signals(1).values;  
