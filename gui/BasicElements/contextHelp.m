...
Infos = {...
    ['NAME and VALUE of an ENTITY ATTRIBUTE\n\n',...
     ...
     ...
    ['Specrule \n\n',...
     'in case of several children a rule for their selection has to be defined\n\n',...
     'usually the decision is made based on the value of a SESVAR\n',...
     'if CONDITION1 is true --> SpecChild1\n',...
     'if CONDITION2 is true --> SpecChild2\n',...
     '(Note: only one condition at a time has to be valid)\n\n',...
     'MATLAB inbuild functions can be used (see example below)'],... %Specrule
    ...
    ['Aspecrule \n\n',...
     'in case of several aspects a rule for their selection has to be defined\n\n',...
     'usually the decision is made based on the value of a SESVAR\n',...
     'if BOOL CONDITION1 is true --> AspectName1\n',...
     'if BOOL CONDITION2 is true --> AspectName2\n',...
     '(Note: only one condition at a time has to be valid)\n\n',...
     'MATLAB inbuild functions ca be used (see example below)'],... %Aspectrule
    ...
    ['Global Priority\n\n',...
     'A global priority which is used for complete pruning to ',...
     'resolve open decisions in case of specialisation'],... %AspPriority
     ....
    ['Couplings\n\n',...
     'to define a coupling you can either use a SESFUN or use a static coupling \n\n',...
     ...
     'please see complete documentation for more infomation\n\n',...
     'when a SESFUN is used for MULTIASPECT Coupling two additional VARS can be used:\n',...
     'Parent     \t curent Name of the Parent\n',...
     'Children  \t list of all children names\n',...
     '\n',...
     'Static couplings for MULTIASPECTs require one set of couplings for each possible number of replications\n',...
     'ATTENTION: Press enter, when altering a value in ''Start'' or ''End'' \n',...
     'otherwise values will not be saved!\n\n',...
     'Choice of ''Cur'' allows to edit one special set of coupling relations.\n',...
     'Example: If ''Cur'' is 3, you edit the couplings for NumRep == 3.\n'],... %Couplings
    ...
    ...
    ['Sematic Condition\n\n',...
     ...
     'MATLAB inbuild functions can be used (see example below)'],... %Semantic Condition
    ...
    ['Selection Constraints\n\n',...
     'are usually used to force a selection at a SpecNode instead of defining an additional condition\n',...
     'please see complete documentation for more infomation'],... %Selection Constraints
    ...
    ['SES Functions\n\n',...
     'are usually used to define procedural knowledge\n',...
     'SES Functions can be used in different ways, for example to define couplings between nodes\n\n',...
